...
public class EventHandlerWorker(IMessageHandler messageHandler, WorkshopManagementDBContext workshopManagementDbContext) : IHostedService, IMessageHandlerCallback
{
